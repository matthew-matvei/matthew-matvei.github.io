...
var $author$project$Main$DateRetrieved = function (a) {
	return {$: 'DateRetrieved', a: a};
};
var $author$project$Main$Model = F3(
	function (key, route, today) {
		return {key: key, route: route, today: today};
	});
...
var $author$project$Article$AreYouProvidingValue = {$: 'AreYouProvidingValue'};
var $author$project$Article$EitherPatternNetworkCalls = {$: 'EitherPatternNetworkCalls'};
var $author$project$Article$ProgrammingAsASecondLanguage = {$: 'ProgrammingAsASecondLanguage'};
...
var $author$project$Article$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Article$ProgrammingAsASecondLanguage,
			$elm$url$Url$Parser$s('programming-as-a-second-language')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Article$AreYouProvidingValue,
			$elm$url$Url$Parser$s('are-you-providing-value')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Article$EitherPatternNetworkCalls,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$updatePrism(_Utils_Tuple0)
					])));
	});
...
var $author$project$Blog$AreYouProvidingValue$getContent = function (_v0) {
	return _List_fromArray(
		[
			...
			A3($justinmimbs$date$Date$fromCalendarDate, 2020, $elm$time$Time$Aug, 3)),
			...
			$author$project$Blog$Content$Section(
			{
				...
				title: $elm$core$Maybe$Just(
					{subTitle: 'You ain\'t gonna need it (probably)', title: 'YAGNI'})
			})
		]);
};
...
var $author$project$Blog$EitherPatternNetworkCalls$getContent = function (_v0) {
	return _List_fromArray(
		[
			...
			$author$project$Blog$Content$WhenCreated(
			A3($justinmimbs$date$Date$fromCalendarDate, 2020, $elm$time$Time$Aug, 9)),
			$author$project$Blog$Content$Section(
			{
				content: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
								[
									$author$project$Blog$Content$Text('A successful response and its possible content')
								]),
								_List_fromArray(
								[
									$author$project$Blog$Content$Text('An unsuccessful response and its error content')
								])
							])),
						$author$project$Blog$Content$Paragraph(
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Blog$Content$Text('This is unfortunately complicated, given that in our heads we\'re simply\n                wanting to capture '),
								$author$project$Blog$Content$Emphasis('if it\'s successful, to this; if it\'s unsuccessful, do that'),
								$author$project$Blog$Content$Text('.')
							])),
						$author$project$Blog$Content$Paragraph(
						_List_fromArray(
							[
								$author$project$Blog$Content$Text('It just so happens there\'s a perfect abstraction that simplified a lot of \n                these network calls\' responses.')
							]))
					]),
				title: $elm$core$Maybe$Nothing
			}),
			...
			$author$project$Blog$Content$Section(
			{
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Blog$Content$Text(' behaviour. Ordinarily, a given function would return a given type of \n                result. Given a naive view of the above '),
								$author$project$Blog$Content$InlineCode('fetch'),
						...
						_List_fromArray(
							[
								$author$project$Blog$Content$Text('With these pieces in place, we can now diff the simplifications.')
							])),
						$author$project$Blog$Content$CodeBlock(
				...
				title: $elm$core$Maybe$Just(
					{subTitle: '... this or that', title: 'Either or'})
			}),
			$author$project$Blog$Content$Divider,
			$author$project$Blog$Content$Section(
			{
...
var $author$project$Blog$ProgrammingAsASecondLanguage$getContent = function (_v0) {
	return _List_fromArray(
		[
			...
			$author$project$Blog$Content$WhenCreated(
			A3($justinmimbs$date$Date$fromCalendarDate, 2020, $elm$time$Time$Jan, 26)),
			$author$project$Blog$Content$Section(
			{
				content: _List_fromArray(
					[
						...
						{
							alt: 'Useless teacher',
							attribution: $author$project$Blog$Content$TextAttribute('Memecenter'),
...
var $author$project$Blog$ThreeBestPractices$getContent = function (_v0) {
	return _List_fromArray(
		[
			...
			$author$project$Blog$Content$WhenCreated(
			A3($justinmimbs$date$Date$fromCalendarDate, 2019, $elm$time$Time$Nov, 15)),
			$author$project$Blog$Content$Section(
			{
				content: _List_fromArray(
					[
			...
			$author$project$Blog$Content$Section(
			{
				...
				title: $elm$core$Maybe$Just(
					{subTitle: 'Trust no one', title: '2. Get defensive'})
			}),
			$author$project$Blog$Content$Divider,
			$author$project$Blog$Content$Section(
			{
				...
				title: $elm$core$Maybe$Just(
					{subTitle: 'But why not try square tyres?', title: '3. Don\'t reinvent the wheel'})
			}),
			$author$project$Blog$Content$Section(
			{
				content: _List_fromArray(
...
var $author$project$Article$getContent = function (slug) {
	switch (slug.$) {
		...
		case 'ProgrammingAsASecondLanguage':
			return $author$project$Blog$ProgrammingAsASecondLanguage$getContent(_Utils_Tuple0);
		case 'AreYouProvidingValue':
			return $author$project$Blog$AreYouProvidingValue$getContent(_Utils_Tuple0);
		default:
			return $author$project$Blog$EitherPatternNetworkCalls$getContent(_Utils_Tuple0);
	}
};
...
var $author$project$Page$Article$viewCodeBlock = function (codeBlock) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('language-' + codeBlock.language)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(codeBlock.code)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(collectionItem.title)
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(collectionItem.text)
					]))
			]));
};
	...
	if (maybeSectionTitle.$ === 'Nothing') {
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(sectionTitle.title)
					])),
				A2(
				$elm$html$Html$h4,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(sectionTitle.subTitle)
					]))
			]);
	}
};
...
var $author$project$Page$Article$viewSection = function (sectionInfo) {
	return A2(
		...
		_Utils_ap(
			$author$project$Page$Article$viewSectionTitle(sectionInfo.title),
			A2($elm$core$List$map, $author$project$Page$Article$viewContent, sectionInfo.content)));
};
...
var $author$project$Component$Card$viewAction = function (action) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$href(action.link)
			]),
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Component$Card$viewAction, model.actions))
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Footer$view(model.today)
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Message","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Message":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"DateRetrieved":["Date.Date"]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));